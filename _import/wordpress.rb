%w(rubygems sequel hpricot fileutils yaml active_support/inflector).each{|g| require g}
...
module WordPress
   # default table_prefix = "wp"
  def self.import(database, user, password, table_prefix = "9ixg", host = 'localhost')
